...
<Steps>
  <Step title="Navigate to the Crawl Settings for your dataset">
  ...
  <Step title="Add the Shopify Store URL, select the Shopify option, and click Start Scraping">
  ...
  <Step title="Navigate to the Demo Page for your dataset">
  ...
  <Step title="Configure the Web Component for your site">
  ...
  <Step title="Add a tab message with code">
  ...
  <Step title="View your demo page">
  ...
  <Step title="Find the code block on the demo page">
  ...
  <Step title="Test and add the script tag to your site">
...
<Steps>
  <Step title="Open the demo page and scroll to the code block">
  ...
  <Step title="Navigate to the site you intend to add the component new and create a new tampermonkey script">
  ...
  <Step title="Paste the following code block into the new tampermonkey script">
  ...
  <Step title="Replace the props in the tampermonkey script with the props from the demo page">
