...
To start a crawl job, you need to make a POST request to the [create crawl](/api-reference/crawl/create-a-new-crawl-request) route.
...
There are some other parameters that will allow you customize the chunks that are created from your crawl job. You can find more information about these parameters in the [API reference](/api-reference/crawl/create-a-new-crawl-request).
