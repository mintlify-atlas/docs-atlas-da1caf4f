...
You can query this custom event data using the [get all events route](/api-reference/analytics/get-all-user-events). This will return all of the custom events that you have sent to the Trieve API.
